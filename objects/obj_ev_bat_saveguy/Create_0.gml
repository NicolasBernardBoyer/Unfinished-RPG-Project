...
speakers = [kat];
next_line = [0];
scripts = [[change_variable, id, "cut_prog", 1]];
...
text2 = ["EEK! IS THAT A NAKED GUY?!? OH MY GOD!",
		 ...
		 "Well then, there is another exit, but it might be dangerous.",
		 "Want me to teach you how to do combat?",
		 "Thanks, but I can defend myself just fine.",
		 "What about your friend here? Can they fight?",
		 "Oh... I'm not so sure. You don't have a weapon, do you " + global.player_name + "?",
...
scripts2 = [[port_swap, 0], [port_swap, 0], [port_swap, 0], [port_swap, 1],
			...
			[-1, -1], [port_swap, 0], [change_variable, id, "cut_prog", 2]];
